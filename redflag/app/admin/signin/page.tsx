  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col items-center gap-4 w-90 bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="font-bold text-xl">Sign in with Google</div>
        <div className="flex flex-col gap-3 w-full">
          <button
            className="bg-white text-gray-700 py-2 px-4 rounded-3xl w-full hover:bg-gray-100 border flex items-center justify-center gap-2"
